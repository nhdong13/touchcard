class AutomationsController < BaseController
  ...
  def start_sending
    ...
    if @automation.budget_type == "monthly" && (@automation.budget < Plan.current_amount || @automation.budget - @automation.budget_used < Plan.current_amount)
